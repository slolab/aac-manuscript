...
The FAIR Guiding Principles describe how digital resources can be made Findable, Accessible, Interoperable, and Reusable by humans and machines [@doi:10.1038/sdata.2016.18].
Their scope encompasses digital research objects beyond conventional data, including software and workflows [@doi:10.1038/sdata.2016.18;@doi:10.1038/s41597-022-01710-x].
The AAC applies these principles prospectively to a specific planning-stage artifact: the structured design contract for an agentic system, extending work on machine-actionable data management plans [@doi:10.1371/journal.pcbi.1006750].
...
The resulting packages support FAIR-aligned management of the design while remaining under the user's full control: they can remain strictly internal, be shared selectively with collaborators or governance boards, or be published openly in research data repositories.
