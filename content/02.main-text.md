...
This means completed canvases are not merely documentation---they are FAIR Digital Objects [@doi:10.1038/sdata.2016.18] that can be validated against a JSON Schema specification, archived in research data repositories, discovered through metadata catalogs, and integrated with existing research infrastructure.
